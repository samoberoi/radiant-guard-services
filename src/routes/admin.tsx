...
function AdminLayout() {
  ...
  return (
    ...
    <div className="relative min-h-dvh lg:h-dvh lg:overflow-hidden">
      ...
      {/* Main */}
      <main className={cn("relative z-10 min-h-[calc(100dvh-3.5rem)] overflow-x-hidden px-3 py-4 transition-[margin] duration-300 sm:px-6 sm:py-6 lg:h-dvh lg:min-h-0 lg:overflow-y-auto lg:overscroll-contain lg:py-8 lg:pr-6", mainOffset)}>
