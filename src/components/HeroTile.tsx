...
export function HeroTile({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-[32px] border border-white/60 bg-gradient-to-br from-white/90 via-white/70 to-accent/[0.04] p-6 backdrop-blur-2xl shadow-[0_1px_0_0_rgba(255,255,255,0.9)_inset,0_30px_80px_-40px_rgba(10,20,40,0.25)] sm:p-9",
        className,
      )}
    >
      ...
      <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0 space-y-3">
          {eyebrow && (
            <div className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white/70 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.24em] text-foreground/70 shadow-sm backdrop-blur">
